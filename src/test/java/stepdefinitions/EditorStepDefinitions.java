...
public class EditorStepDefinitions {
    ...
    @Then("Start olarak {string} yazar")
    public void start_olarak_yazar(String startDate) {
        editorPage.startDateBox.sendKeys(startDate + Keys.ENTER);
    ...
    public void kullanici_ile_arama_yapar(String firstname) {
        editorPage.searchBoxElementi.sendKeys(firstname);

    }
    @Then("isim bolumunde {string} oldugunu dogrular")
    public void isim_bolumunde_oldugunu_dogrular(String firstname) {
    String sonucStr=editorPage.aramaSonucuElementi.getText();
